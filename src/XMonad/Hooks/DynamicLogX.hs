...
module XMonad.Hooks.DynamicLogX (
    -- * Usage
    -- $usage
...
dzenPP :: PP
dzenPP = def { ppCurrent  = pure . dzenColor "white" "#2b4f98" . pad
                   , ppVisible  = pure . dzenColor "black" "#999999" . pad
                   , ppHidden   = pure . dzenColor "black" "#cccccc" . pad
                   , ppHiddenNoWindows = const ""
...
xmobarPP :: PP
xmobarPP = def { ppCurrent = pure . xmobarColor "yellow" "" . wrap "[" "]"
...
-- 'def'.
sjanssenPP :: PP
sjanssenPP = def { ppCurrent = pure . xmobarColor "white" "black"
...
byorgeyPP = def { ppHiddenNoWindows = showNamedWorkspaces
                , ppHidden  = pure . dzenColor "black"  "#a8a3f7" . pad
                , ppCurrent = pure . dzenColor "yellow" "#a8a3f7" . pad
                , ppUrgent  = dzenColor "red"    "yellow"  . pad
                , ppSep     = " | "
                , ppWsSep   = ""
                , ppTitle   = shorten 70
